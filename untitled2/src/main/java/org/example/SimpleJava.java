...
public class SimpleJava {
    ...
    public static void main(String[] args) throws IOException {
        MutableDataSet options = new MutableDataSet().set(Parser.EXTENSIONS, Collections.singletonList(HtmlConverterTextExtension.create()));
        //File的对象为本地html文件地址
        File fileHtml=new File("src/external/html/simply.html");//使用commons的io将文件中的内容转换成字符串
...
//                "</ul>";
        ...
        System.out.println("\nMarkdown:");
        FileOutputStream fos=new FileOutputStream("src/external/markdown/simply.md");
        IOUtils.write(markdown,fos);
